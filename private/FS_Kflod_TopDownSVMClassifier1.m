...
function [accuracyMean,accuracyStd,F_LCAMean,FHMean,TIEmean,accuracy_l,accuracy_mon,FHStd,TIEStd,accuracy_monStd,FH,TIE] = FS_Kflod_TopDownSVMClassifier1(data, numFolds, tree, feature, numberSel,indices,randIndex,Method)
[M,N]=size(data);
...
for k = 1:numFolds
    ...
    %%           Prediction       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [predict_label] = FS_topDownSVMPrediction(test_data, modelSVM, tree,feature,numberSel,Method) ;
